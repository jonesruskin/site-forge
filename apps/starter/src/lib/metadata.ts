...
/**
 * Social image used when a page doesn't pass one: `seo.ogImage`, else the image
 * generated by the seo module. Page-level `openGraph` replaces the parent's, so
 * every page must name its image explicitly or it would lose it.
 */
