...
export function PaymentFailedEmail({ portalUrl }: { portalUrl: string }) {
  return (
    <EmailLayout preview={`Your ${siteConfig.name} payment didn't go through`}>
      ...
      <EmailText>
        We couldn&apos;t charge your card for your {siteConfig.name} subscription. We&apos;ll retry automatically, but updating
        your payment method now avoids any interruption.
      </EmailText>
